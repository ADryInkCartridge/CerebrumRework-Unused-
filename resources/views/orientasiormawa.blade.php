...
@section('content')
    <div id="tambahoverlay" class="absolute inset-0 hidden justify-center bg-black bg-opacity-50 z-10 items-center">
        ...
        <div class="items-center flex gap-x-20 text-white ">
            <button class="w-36 h-14 bg-tablehead rounded-md font-semibold">Upload File</button>
            <button class="w-36 h-14 bg-tablegreen rounded-md font-semibold">Manual</button>
        </div>
      </div>
    </div>
    <div class="py-8 pr-10 pl-5 flex flex-col font-sans">
        <div class="flex justify-between">
            <div class="flex flex-col text-white">
                <span class="text-3xl pb-4">Orientasi Ormawa</span>
                    <div class="relative">
            ...
            <div class="flex flex-col justify-end">
                <button id="tambahbtn" class="bg-tablehead rounded-md h-8 text-white font-semibold mb-3">
                    Tanbah Mahasiswa +
                </button>
        ...
        <div class="pt-5 w-full">
            <div class="table w-full rounded-2xl overflow-hidden">
                ...
                <div class="table-row h-20 bg-tablehead text-white text-xl font-semibold ">
                    ...
                    <div class="table-row h-20 text-white text-xl font-semibold ">
                        ...
                        <div class="table-cell w-32 text-center align-middle relative">
                            ...
                            <div id="editdropdown" class="absolute bg-white text-black text-sm hidden flex-col mx-auto right-0 w-32 left-0 rounded-md overflow-hidden shadow-xl">
                                <button id="closeedit" class="self-end bg-tablehead w-full flex justify-end pr-2 h-6">x</button>
                                <a href="">
